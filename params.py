...
def get_params():
    ...
    args.add_argument("-seed", "--seed", default=2022, type=int)   #fb15k2022   wiki2023    nell2024
    ...
    args.add_argument("-lr", "--learning_rate", default=0.0001, type=float)  # 0.001
    ...
    args.add_argument("-max_neighbor", "--max_neighbor", default=250, type=int)
    ...
    args.add_argument("--flow", choices=['none', 'Planar', 'Radial', 'RealNVP'], default='Planar', type=str)
