...
class Trainer:
    ...
    def logging_training_data(self, data, epoch):
        logging.info("Epoch: {}\tMRR: {:.3f}\tHits@10: {:.3f}\tHits@5: {:.3f}\tHits@1: {:.3f}\tHit@1Accuracy: {:.2f}%\r".format(
        epoch, data['MRR'], data['Hits@10'], data['Hits@5'], data['Hits@1'], data['Hit@1Accuracy']))
    ...
    def logging_eval_data(self, data, state_path, istest=False):
        ...
        logging.info("MRR: {:.3f}\tHits@10: {:.3f}\tHits@5: {:.3f}\tHits@1: {:.3f}\r".format(
            data['MRR'], data['Hits@10'], data['Hits@5'], data['Hits@1'],data['Hit@1Accuracy']))
    ...
    def eval(self, istest=False, epoch=None):
        ...
        data['Hit@1Accuracy'] = data['Hits@1'] * 100
        ...
        print("{}\tMRR: {:.3f}\tHits@10: {:.3f}\tHits@5: {:.3f}\tHits@1: {:.3f}\tHit@1Accuracy: {:.2f}%\r".format(
            t, data['MRR'], data['Hits@10'], data['Hits@5'], data['Hits@1'], data['Hit@1Accuracy']))
